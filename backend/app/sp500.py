"""S&P 500 universe for the screener (yfinance ticker format).

Class shares use '-' instead of '.' (e.g. BRK.B -> BRK-B) to match Yahoo.
This list is a snapshot and does not need to be perfectly current for a
momentum screen — it is easy to edit by hand.
"""
...
SP500: list[str] = [
    ...
    "CDW", "CE", "COR", "CNC", "CNP", "CF", "CHRW", "CRL", "SCHW", "CHTR",
    ...
    "CSX", "CMI", "CVS", "DHR", "DRI", "DVA", "DAY", "DECK", "DE", "DAL",
    "XRAY", "DVN", "DXCM", "FANG", "DLR", "DFS", "DG", "DLTR", "D", "DPZ",
    ...
    "LW", "LVS", "LDOS", "LEN", "LLY", "LIN", "LYV", "LKQ", "LMT", "L",
    ...
    "WELL", "WST", "WDC", "WY", "WMB", "WTW", "GWW", "WYNN", "XEL", "XYL",
    "YUM", "ZBRA", "ZBH", "ZTS",
]
